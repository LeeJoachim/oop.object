...
abstract class BasicRatePolicy implements RatePolicy {
    ...
    public Money calculateFee(Phone phone) {
        ...
        for(Call call : phone.getCalls()) {
            result = result.plus(calc(call));
        }

        return result;
    }

    protected abstract Money calc(Call call);
}
...
class FixedFeePolicy extends BasicRatePolicy {
    ...
    @Override
    protected Money calc(Call call) {
...
public class TestDriver {
    public static void main(String[] args) {
        Phone phone = new Phone(
            new TaxablePolicy(2.0,
            new FixedFeePolicy(Money.wons(5), Duration.ofSeconds(10))));

        phone.call(new Call(LocalDateTime.of(2018, 1, 1, 11, 0),
                LocalDateTime.of(2018, 1, 2, 11, 10)));

        phone.call(new Call(LocalDateTime.of(2018, 1, 2, 12, 0),
                LocalDateTime.of(2018, 1, 10, 12, 10)));
